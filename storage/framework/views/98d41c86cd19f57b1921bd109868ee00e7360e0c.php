...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-productCategories">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($category->id); ?>">
                            ...
                            <td>
                                <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="badge badge-info">
                                        <a href="<?php echo e(route('admin.products.show', $item->id)); ?>" style="text-decoration: none;"><?php echo e($item->name); ?></a> 
                                    </span>
...
<?php endif; ?>
  ...
  let table = $('.datatable-productCategories:not(.ajaxTable)').DataTable({ buttons: dtButtons })
...
<?php $__env->stopSection(); ?><?php /**PATH /var/www/CubeAssessment/resources/views/admin/products/relationships/productCategories.blade.php ENDPATH**/ ?>