<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product_management_access')): ?>
            <li class="c-sidebar-nav-dropdown <?php echo e(request()->is("admin/variants*") ? "c-show" : ""); ?> <?php echo e(request()->is("admin/products*") ? "c-show" : ""); ?> <?php echo e(request()->is("admin/categories*") ? "c-show" : ""); ?>">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('variant_access')): ?>
                        <li class="c-sidebar-nav-item">
                            <a href="<?php echo e(route("admin.variants.index")); ?>" class="c-sidebar-nav-link <?php echo e(request()->is("admin/variants") || request()->is("admin/variants/*") ? "c-active" : ""); ?>">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                                </i>
                                <?php echo e(trans('cruds.variant.title')); ?>
...
</div><?php /**PATH /var/www/CubeAssessment/resources/views/partials/menu.blade.php ENDPATH**/ ?>