...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-variantProducts">
                <thead>
                    <tr>
                        <th width="10">
...
<?php endif; ?>
  ...
  let table = $('.datatable-variantProducts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
...
<?php $__env->stopSection(); ?><?php /**PATH /var/www/CubeAssessment/resources/views/admin/variants/relationships/variantProducts.blade.php ENDPATH**/ ?>