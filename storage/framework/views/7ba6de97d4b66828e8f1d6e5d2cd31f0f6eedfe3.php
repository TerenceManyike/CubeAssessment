    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.categories.update", [$category->id])); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>" type="text" name="name" id="name" value="<?php echo e(old('name', $category->name)); ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('meta_title') ? 'is-invalid' : ''); ?>" type="text" name="meta_title" id="meta_title" value="<?php echo e(old('meta_title', $category->meta_title)); ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('meta_description') ? 'is-invalid' : ''); ?>" type="text" name="meta_description" id="meta_description" value="<?php echo e(old('meta_description', $category->meta_description)); ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('meta_keywords') ? 'is-invalid' : ''); ?>" type="text" name="meta_keywords" id="meta_keywords" value="<?php echo e(old('meta_keywords', $category->meta_keywords)); ?>">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('products') ? 'is-invalid' : ''); ?>" name="products[]" id="products" multiple>
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e((in_array($id, old('products', [])) || $category->products->contains($id)) ? 'selected' : ''); ?>><?php echo e($product); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/CubeAssessment/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>